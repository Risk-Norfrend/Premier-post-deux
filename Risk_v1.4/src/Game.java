...
public class Game extends BasicGame {
	...
	private Faction[] allFaction;
	private PlayerList AllPlayerList;
	...
	public void init(GameContainer container) throws SlickException {
		...
		Faction EbonBlade = new Faction("The Ebon Blade", "Faction/EbonBladeInfantry",  "Faction/EbonBladeCavalry", "Faction/EbonBladeCanon" );
		Faction KirinThor = new Faction( "The Kirin Thor", "Faction/KirinThorInfantry", "Faction/KirinThorCavalry", "Faction/KirinThorCanon");
		Faction Stormwind = new Faction("Stormwind Kingdom", "Faction/StormwindInfantry", "Faction/Stormwindcavalry", "Faction/StormwindCanon");
		Faction Ironforge = new Faction("Ironforge Kingdom", "Faction/IronforgeInfantry", "Faction/IronforgeCavalry", "Faction/IronforgeCanon");
		Faction Forsaken = new Faction("The Forsaken", "Faction/ForsakenInfantry", "Faction/ForsakenCavalry", "Faction/ForsakenCanon");
		Faction Orgrimmar = new Faction("Orgrimmar", "Faction/OrgrimmarInfantry", "Faction/OrgrimmarCavalry", "Faction/OrgrimmarCanon");
		Faction Darkspear = new Faction("Darkspear", "Faction/DarkspearInfantry", "Faction/DarkspearCavalry", "Faction/DarkspearCanon");
		Faction ArgentCrusade = new Faction("Argent Crusade", "Faction/ArgentCrusadeInfantry", "Faction/ArgentCrusadeCavalry", "Faction/ArgentCrusadeCanon");
		Faction Scourge = new Faction("The Scourge", "Faction/ScourgeInfantry", "Faction/ScourgeCavalry", "Faction/ScourgeCanon");
		Faction Eredar = new Faction("Eredar", "Faction/EredarInfantry", "Faction/EredarCavalry", "Faction/EredarCanon");
		Faction OldGods = new Faction("Oldgods", "Faction/OldgodsInfantry", "Faction/OldgodsCavalry", "Faction/OldgodsCanon");
		Faction BlueDragonflight = new Faction("The Blue Dragonflight", "Faction/BlueDragonflightInfantry", "Faction/BlueDragonflightCavalry", "Faction/BlueDragonflightCanon");
		Faction[] FactionArray = new Faction[12];
		FactionArray[0] = EbonBlade;
		FactionArray[1] = KirinThor;
		FactionArray[2] = Stormwind;
		FactionArray[3] = Ironforge;
		FactionArray[4] = Forsaken;
		FactionArray[5] = Orgrimmar;
		FactionArray[6] = Darkspear;
		FactionArray[7] = ArgentCrusade;
		FactionArray[8] = Scourge;
		FactionArray[9] = Eredar;
		FactionArray[10] = OldGods;
		FactionArray[11] = BlueDragonflight;
		this.allFaction = FactionArray;
		
		
		
		// Sholazar' Territories		
				Territory territory1 = new Territory("The Nexus",false,"1.png",1, 595,420);
				Territory territory2 = new Territory("Warsong Hold",false,"2.png",2,666,301);
				Territory territory3 = new Territory("Vaillance Keep",true,"3.png",3,763,314);
				Territory territory4 = new Territory("Amber ledge",false,"4.png",4,733,434);
				Territory territory5 = new Territory("Mosslight Pillar",false,"5.png",5,725,534);
				Territory territory6 = new Territory("Maker's Perch",false,"6.png",6,735,601);
				Territory territory7 = new Territory("Glimmering Pillar",false,"7.png",7,811,654);
				Territory territory8 = new Territory("Maker's Overlook",false,"8.png",8,888,607);
				Territory territory9 = new Territory("Skyreach Pillar",false,"9.png",9,813,559);
				Territory territory10 = new Territory("Taunka'l Village",false,"10.png",10,823,437);
				Territory territory11 = new Territory("En'Kilah",false,"11.png",11,911,407);
				...
				Territory territory12 = new Territory("Wintergrasp",false,"12.png",12,957,510);
				Territory territory13 = new Territory("Azjol'Nerub",false,"13.png",13,1023,399);
				Territory territory14 = new Territory("Agmar's Hammer",false,"14.png",14,1119,396);
				Territory territory15 = new Territory("Wyrmrest Temple",false,"15.png",15,1210,401);
				Territory territory16 = new Territory("Angrathar",false,"16.png",16,1149,503);
				Territory territory17 = new Territory("Dalaran",false,"17.png",17,1186,588);
				Territory territory18 = new Territory("Cristalsong Forest",false,"18.png",18,1316,585);
				Territory territory19 = new Territory("Naxxramas",false,"19.png",19,1329,455);
				Territory territory20 = new Territory("New Hearthglen",false,"20.png",20,1327,354);
				Territory territory21 = new Territory("Conquest Hold",true,"21.png",21,1452,354);
				Territory territory22 = new Territory("Drak'Tharon Keep",false,"22.png",22,1450,461);
				...
				Territory territory23 = new Territory("Zeramas",false,"23.png",23,1423,570);
				Territory territory24 = new Territory("Argent Stand",false,"24.png",24,1526,564);
				Territory territory25 = new Territory("Grizzlemaw",false,"25.png",25,1564,442);
				Territory territory26 = new Territory("Gjalerbron",false,"26.png",26,1566,345);
				Territory territory27 = new Territory("Westguard Keep",false,"27.png",27,1570,232);
				Territory territory28 = new Territory("New Agamand",false,"28.png",28,1622,109);
				Territory territory29 = new Territory("Nifflevar",false,"29.png",29,1761,223);
				Territory territory30 = new Territory("Utgarde Keep",false,"30.png",30,1673,237);
				Territory territory31 = new Territory("Dun Argol",false,"31.png",31,1719,364);
				Territory territory32 = new Territory("Bloodmoon Isle",true,"32.png",32,1692,487);
				Territory territory33 = new Territory("Kalramas",false,"33.png",33,1634,575);
				Territory territory34 = new Territory("Gundrak",false,"34.png",34,1650,684);
				Territory territory35 = new Territory("Altar of Rhunok",false,"35.png",35,1530,644);
				...
				Territory territory36 = new Territory("Thunderfall",false,"36.png",36,1545,796);
				Territory territory37 = new Territory("Terrace of the Makers",false,"37.png",37,1450,779);
				Territory territory38 = new Territory("Ulduar",false,"38.png",38,1375,907);
				Territory territory39 = new Territory("Grom'arsh",false,"39.png",39,1314,807);
				Territory territory40 = new Territory("Frosthold",false,"40.png",40,1348,690);
				Territory territory41 = new Territory("Argent Vanguard",false,"41.png",41,1231,695);
				Territory territory42 = new Territory("Ymirheim",false,"42.png",42,1095,710);
				Territory territory43 = new Territory("Syndragosa's Fall",false,"43.png",43,1149,822);
				Territory territory44 = new Territory("Shadow Vault",false,"44.png",44,970,812);
				Territory territory45 = new Territory("Fleshwerks",false,"45.png",45,955,716);
				Territory territory46 = new Territory("Onslaught Harbor",true,"46.png",46,827,763);
				Territory territory47 = new Territory("Icecrown Citadel",false,"47.png",47,973,615);
				...
				territory13.NeighbourNumber = 2;
				arrayterri13[0] = territory11;
				arrayterri13[1] = territory14;
				territory13.Neighbour = arrayterri13;
				
				Territory[] arrayterri14 = new Territory[3];
				territory14.NeighbourNumber = 3;
				arrayterri14[0] = territory13;
				arrayterri14[1] = territory15;
				arrayterri14[2] = territory16;
				territory14.Neighbour = arrayterri14;
				
				Territory[] arrayterri15 = new Territory[4];	
				territory15.NeighbourNumber = 4;
				...
				Territory[] arrayterri17 = new Territory[2];
				territory17.NeighbourNumber = 2;
				...
				Territory[] arrayterri41 = new Territory[4];	
				territory41.NeighbourNumber = 4;
				...
				Territory[] arrayterri43 = new Territory[3];
				territory43.NeighbourNumber = 3;
				arrayterri43[0] = territory39;
				arrayterri43[1] = territory42;
				arrayterri43[2] = territory44;
				territory43.Neighbour = arrayterri43;
				
				Territory[] arrayterri44 = new Territory[3];	
				territory44.NeighbourNumber = 3;
				...
				// Tableau des 4 régions stockées dans map
				Region[] AllRegionArray = new Region[4];	
				AllRegionArray[0] = Sholazar;
				AllRegionArray[1] = Dragonblight;
				AllRegionArray[2] = ZulDrak;
				AllRegionArray[3] = Icecrown;
				this.map.allregion = AllRegionArray;
				
				// Initalisation des joueurs
				Player Player1 = new Player("Player1", Forsaken, true );
				Player Player2 = new Player("Player2", Stormwind, true );
				Player Player3 = new Player("Player3", Scourge, true );
				Player Player4 = new Player("Player4", Ironforge, true );
				Player Player5 = new Player("Player5", KirinThor, true );
				Player Player6 = new Player("Player6", OldGods, true );
				
				PlayerList AllPlayerList = new PlayerList(Player1);
				PlayerList PlayerList2 = new PlayerList(Player2);
				PlayerList PlayerList3= new PlayerList(Player3);
				PlayerList PlayerList4 = new PlayerList(Player4);
				PlayerList PlayerList5 = new PlayerList(Player5);
				PlayerList PlayerList6 = new PlayerList(Player6);
				
				AllPlayerList.suivant = PlayerList2;
				PlayerList2.suivant = PlayerList3;
				PlayerList3.suivant = PlayerList4;
				PlayerList4.suivant = PlayerList5;
				PlayerList5.suivant = PlayerList6;
				PlayerList6.suivant = AllPlayerList;
				...
				this.map.allterritory[17].infantryNumber += 10;
				this.map.allterritory[17].movement(this.map.allterritory[17].Neighbour[0],5,0,0);
	...
	public void render(GameContainer container, Graphics g) throws SlickException {
    	...
    	String ymot = ""+ypos;
    	int unit1=root.infantryNumber;
    	String motunit = ""+unit1;
    	g.drawString(xmot, 200, 100);
    	g.drawString(ymot, 250, 100);
    	g.drawString(motunit, 350, 100);
	    
	    Territory[] voisin1 = root.Neighbour;
	    for(int i = 0; i < root.NeighbourNumber; i++) {
	    	
	    	Image voisin = new Image("image/Territory/"+voisin1[i].imageName);
	    	g.drawImage(voisin, 0, 0, 0 ,0, 1920, 975);
	    }
	    
	    /**for(int i =0; i < this.map.allterritory.length; i++) {
	    	this.map.allterritory[i].displayStrenght(g);
	    }**/
	}
	...
	public Territory selectTerritory(int x, int y, Territory[] AllTerritoryArray) {
		Territory empty = new Territory(" ",false,"0.png",0,0,0);
	...
	public static int startGameUnit(int playerNumber) {
